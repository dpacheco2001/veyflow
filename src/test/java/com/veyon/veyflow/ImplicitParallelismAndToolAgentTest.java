...
public class ImplicitParallelismAndToolAgentTest {
    ...
    void testToolAgentWithRedisPersistence() {
        ...
        try {
            ...
            log.info(ANSI_GREEN + "WorkflowConfig successfully retrieved and verified from Redis." + ANSI_RESET);
            ...
            if (redisConnection != null) {
                try {
                    String agentStateKey = "agentstate:" + uniqueTestTenantId + "::" + uniqueTestThreadId; 
